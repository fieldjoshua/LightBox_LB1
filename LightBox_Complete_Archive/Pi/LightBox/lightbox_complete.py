...
# Import optimized animation loop
try:
    from core.optimized_animation_loop import OptimizedAnimationLoop
    OPTIMIZED_AVAILABLE = True
except ImportError:
    OPTIMIZED_AVAILABLE = False
    print("⚠️  OptimizedAnimationLoop not available, using standard loop")
...
class Conductor:
    ...
    def _init_matrix(self):
        ...
        try:
            ...
            if hardware_pwm == 'on' or (hardware_pwm == 'auto'):
                options.disable_hardware_pulsing = False  # Enable hardware PWM
                print("🔧 Hardware PWM enabled (jumper mod detected)")
            else:
...
class LightBoxSystem:
    ...
    def _optimized_animation_loop(self):
        ...
        try:
            ...
            if animation_func:
                self.optimized_loop.run_animation(animation_func)
            else:
