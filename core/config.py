...
class ConfigManager:
    ...
    def gamma_correct(self, value: float, gamma: float | None = None) -> float:
    ...
    def xy_to_index(self, x: int, y: int) -> int | None:
    ...
    def index_to_xy(self, index: int) -> tuple[int, int] | None:
