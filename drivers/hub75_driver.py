...
try:
    ...
    from scripts.util.hardware_detect import check_cpu_isolation, detect_hardware_pwm, get_system_info
...
class HUB75Driver(MatrixDriver):
    ...
    def update(self, frame_buffer: list[tuple[int, int, int]] | bytearray) -> None:
