"""
Parametric Waves - Optimized HUB75 Animation
...
def animate(pixels: List[Tuple[int, int, int]], config, frame: int) -> None:
    """
    Parametric Waves animation frame renderer.
    ...
    """Parametric Waves animation - 75% optimized with all required patterns"""
    ...
    ANIMATION_INFO = {
        'name': 'Parametric Waves 75% Optimized',
