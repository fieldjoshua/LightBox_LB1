"""
Simple Gradient Hub75 - Optimized HUB75 Animation
...
def animate(pixels: List[Tuple[int, int, int]], config, frame: int) -> None:
    """
    Simple Gradient Hub75 animation frame renderer.
    ...
    """Simple Gradient Hub75 animation - 75% optimized with all required patterns"""
    ...
    ANIMATION_INFO = {
        'name': 'Simple Gradient Hub75 75% Optimized',
